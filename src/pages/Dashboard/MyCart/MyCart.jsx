    ...
    const handleDelete = (item) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://saucy-culinary-school-server-production.up.railway.app/carts/${item._id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
                    ...
                    <tbody>

                        {
                            ...
                            >
                                ...
                                <td>${item.price}</td>
                                <td>
                                    <button onClick={() => handleDelete(item)} className="btn bg-[#fd8250] btn-xs text-white">Delete</button>
                                </td>
                                <td>
